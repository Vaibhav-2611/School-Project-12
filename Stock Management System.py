#   project name    : Grocery Stock Management System
...
def item_status(idr):
    conn = mysql.connector.connect(
        host='localhost', database='stock', user='root', password="VChintu2611")
    cursor = conn.cursor()
...
def report_sold_items(): 
      conn = mysql.connector.connect( host='localhost', database='stock', user='root', password="VChintu2611") 
      cursor = conn.cursor() 
      today = date.today() 
